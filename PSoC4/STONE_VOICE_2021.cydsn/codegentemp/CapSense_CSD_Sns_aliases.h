...
#define CapSense_CSD_Sns_Button12__BTN			(CapSense_CSD_Sns__Button12__BTN__PC)
#define CapSense_CSD_Sns_Button12__BTN_PS		(CapSense_CSD_Sns__Button12__BTN__PS)
#define CapSense_CSD_Sns_Button12__BTN_PC		(CapSense_CSD_Sns__Button12__BTN__PC)
#define CapSense_CSD_Sns_Button12__BTN_DR		(CapSense_CSD_Sns__Button12__BTN__DR)
#define CapSense_CSD_Sns_Button12__BTN_SHIFT	(CapSense_CSD_Sns__Button12__BTN__SHIFT)
#define CapSense_CSD_Sns_Button12__BTN_INTR	((uint16)((uint16)0x0003u << (CapSense_CSD_Sns__12__SHIFT*2u)))
